import { ADD_TOKEN, LOGIN_SUCCESS, LOGOUT, UPDATE_MAIL, UPDATE_REDSOC1, UPDATE_REDSOC2, UPDATE_REDSOC3, UPDATE_IMG } from '../actions/useractions';
...
const userReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case LOGIN_SUCCESS:
            return {
                ...state, logged: true, apodo: action.payload.apodo,rol:action.payload.rol,idUser: action.payload.idUser, mail: action.payload.mail,
